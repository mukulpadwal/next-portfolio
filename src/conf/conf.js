const conf = {
  ...
  appwriteCollectionID: String(process.env.NEXT_APP_APPWRITE_COLLECTION_ID),
  hashnodeHost: String(process.env.NEXT_PUBLIC_APP_HASHNODE_HOST),
  resumeLink: String(process.env.NEXT_APP_RESUME_LINK),
  emailjsServiceID: String(process.env.NEXT_APP_EMAILJS_SERVICE_ID),
  emailjsTemplateID: String(process.env.NEXT_APP_EMAILJS_TEMPLATE_ID),
