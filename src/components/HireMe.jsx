  ...
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center'>
        <div className='w-48 h-auto flex items-center justify-center relative'>
            ...
            <Link href={'mailto:mukulpadwal786@gmail.com'} className='flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  shadow-md border border-solid border-dark w-20 h-20 rounded-full font-semibold bg-dark hover:bg-light text-light hover:text-dark  dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light'>Hire Me</Link>
        </div>
    </div>
  )
}
